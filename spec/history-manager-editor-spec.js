...
describe('RecentProjectEditor', () => {
  ...
  beforeEach(() => {
    ...
    activationPromise = atom.packages.activatePackage('history-manager-editor');
  });

  describe('when the history-manager-editor:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      // Before the activation event the view is not on the DOM, and no panel
      // has been created
      expect(workspaceElement.querySelector('.history-manager-editor')).not.toExist();
